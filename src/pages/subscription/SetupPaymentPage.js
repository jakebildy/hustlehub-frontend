...
export default function SetupPaymentPage() {
    ...
    return <Box>
        ...
        <Grid item xs={12} sm={8} md={5} lg={4} xl={4} >
            <Card style={{margin: "30px", paddingTop: "30px", paddingBottom: "2px", position: "relative"}}>
                    
                    <Typography style={{fontSize: "50px", paddingTop: "20px"}}>Free</Typography>


                    <Typography style={{fontSize: "20px", paddingTop: "20px"}}>Until you complete your first job,</Typography>
                    <Typography style={{fontSize: "20px" }}>then $5 a month</Typography>

                    <Button variant="outlined" style={{background: "#E1F9FF", marginTop: "40px", marginBottom: "40px"}} color="primary" onClick={()=>handleClick("freemium")}>
                        Select
                    </Button>
        ...
        <Grid item xs={12} sm={8} md={5} lg={4} xl={4} >
            <Card style={{margin: "30px", position: "relative"}}>
                    ...
                    <Typography style={{fontSize: "70px", paddingTop: "20px"}}>4</Typography>
                    ...
                    <Typography style={{fontSize: "20px", fontWeight: "bold", paddingTop: "20px"}}>Yearly</Typography>
                    <Typography style={{fontSize: "20px" }}><i>pay $48 upfront and <b>save 20%</b></i></Typography>

                    <Button variant="outlined" style={{background: "#E1F9FF", marginTop: "40px", marginBottom: "40px"}} color="primary" onClick={()=>handleClick("yearly")}>
                        Select
                    </Button>
        ...
        <Box
            ...
            <Typography style={{ color: "white", fontSize: "40px", fontWeight: "bold", }}>Choose your package</Typography>
            {/* <Box width="500px">
